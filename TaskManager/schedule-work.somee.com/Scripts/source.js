function Init() {
        ...
        $('.agenda-date').click(function(e) {
            ...
            for (var i = 0; i < $($($(this).parent()[0]).find("td")[1]).find("li").length; i++) {
                ...
                td4.appendChild(document.createTextNode(
                    $.trim($($($($(this).parent()).find("td")[4]).find("li")[i]).text())));
                td4.style.width = "1px";
    ...
    $("#sup").click(function() {
        ...
        for (var i = 0; i < a.length; i++) {
            ...
            var w = {
                ...
                Id: $.trim($(elements[3]).text()),
                Date: ($.trim($(document.getElementById("str")).text()).split(' ')[1])
            };
            var person = { Name: "Sa" };
            $.post("/Home/People", w, null, "json");
        }
    ...
    $("#ups").click(function() {
        if (s == undefined) {
            s = document.getElementById('upss').rows.length;
        }
    ...
    $("#save_table").click(function() {
        ...
        for (var i = 0; i < a.length; i++) {
            ...
            var w = {
                PlanText: $.trim($(elements[1]).text()),
                PlanResult: $.trim($(elements[2]).text()),
